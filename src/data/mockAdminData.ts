...
export const MOCK_REQUIRES_ATTENTION: RequiresAttentionItem[] = [
  ...
  },
  {
    id: 'att-2',
    type: 'bo_cash_float',
    label: '5 Cash / Float requests awaiting review',
    count: 5,
    badgeLabel: 'Manual Queue',
    targetRoute: '/super-admin/operations/cash-float-requests?status=Pending Review',
    severity: 'info',
  },
  {
    id: 'att-3',
  ...
  },
  {
    id: 'att-4',
    type: 'finding_agent',
    label: '2 Requests Finding an Agent',
    count: 2,
    badgeLabel: 'Finding Agent',
...
export const MOCK_NOTIFICATIONS: AdminNotification[] = [
  {
    ...
    read: false,
    actionUrl: '/wallets/customer-withdrawals?status=Pending Review',
  },
  {
    id: 'notif-2',
    title: 'Cash request awaiting Business Owner',
    category: 'Operations',
    timestamp: '8 mins ago',
    read: false,
    actionUrl: '/operations/cash-float-requests',
  },
  {
    id: 'notif-3',
    ...
    read: false,
    actionUrl: '/wallets/reconciliation',
  },
  {
    id: 'notif-4',
    title: 'Pickup request has no Agent',
    category: 'Operations',
    timestamp: '22 mins ago',
    read: false,
    actionUrl: '/operations/matching',
  },
];
