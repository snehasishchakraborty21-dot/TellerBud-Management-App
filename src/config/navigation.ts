...
export const SUPER_ADMIN_NAVIGATION_CONFIG: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'matching-offers',
        label: 'Matching & Offers',
        path: '/super-admin/operations/matching',
        icon: Compass,
        badge: 6,
      },
      {
        ...
        path: '/super-admin/operations/cash-float-requests',
        icon: Banknote,
        badge: 5,
      },
      {
      ...
      {
        id: 'walk-in-transactions',
        label: 'Walk-In Transactions',
        path: '/super-admin/walk-in-transactions',
        icon: Store,
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        path: '/super-admin/people/attendance',
        icon: CalendarCheck,
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: 'walk-in-transactions',
        label: 'Walk-In Transactions',
        path: '/business-owner/walk-in-transactions',
        icon: Store,
      },
    ],
  },
